...
module.exports = {
  ...
  database: {
    connectionString: process.env.DATABASE_URL ||
      `postgresql://${process.env.PGUSER || 'postgres'}:${process.env.PGPASSWORD || '7297'}@${process.env.PGHOST || defaultHost}:${process.env.PGPORT || '5432'}/${process.env.PGDATABASE || 'polyaccess'}`,
